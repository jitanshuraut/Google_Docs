    ...
    <>
      ...
      <div className={style.starter_box}>
        ...
        <div className={style.box_st}>
          ...
          <div className={style.link_extra}>
            <Link to="creat" state={{ from: letter }}>
              <img src="resume.png" alt="" className={style.st_box} />
            </Link>
            <h3>Resume</h3>
          </div>
          <div className={style.link_extra}>
            <Link to="creat" state={{ from: Brochure }}>
